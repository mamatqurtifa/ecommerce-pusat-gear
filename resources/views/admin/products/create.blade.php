...
@section('page-description', 'Create a new product with pricing, inventory, and complete details.')
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <textarea id="short_description" 
                                      ...
                                      placeholder="Brief product description for preview">{{ old('short_description') }}</textarea>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-xl p-4">
                    <div class="flex gap-3">
                        ...
                        <div>
                            <h4 class="text-sm font-semibold text-gray-900 mb-1">Product Guidelines</h4>
                            <p class="text-xs text-gray-600">Ensure all required fields are filled. High-quality images improve product visibility.</p>
                        </div>
                    </div>
                </div>
            </div>
